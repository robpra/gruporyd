...
/**
 * Image Assets
 * Note: You can specify the assets to use below in array formatroundButtons
 */
...
function UpdateUI(){
    ...
    if(windowWidth > UiMaxWidth){
        ...
        if(selectedBuddy == null && selectedLine == null) {
           ...
           //RRR $("#rightContent").css("border-right-width", "1px");
        }
    } else {
        // Touching Edges
        ...
        //RRR $("#rightContent").css("border-right-width", "0px");
    }
    ...
    if(windowWidth < 920){
        ...
        if(selectedBuddy == null & selectedLine == null) {
            $("#leftContent").css("width", "100%");
          //RRR  $("#rightContent").css("margin-left", "0px");
            $("#leftContent").show();
            $("#rightContent").hide();
        }
        else{
            $("#leftContent").css("width", "320px");
            // RRR $("#rightContent").css("margin-left", "320px");
            $("#leftContent").show();
            // RRR$("#rightContent").show();
...
function InitUi(){
   ...
   //RRR }
    ...
    // Lines & Buddies
    // RRR leftHTML += "<div id=myContacts class=\"contactArea cleanScroller\"></div>"
...
function onInviteAccepted(lineObj, includeVideo, response){
    ...
    if(includeVideo){
        ...
        $("#line-"+ lineObj.LineNumber +"-btn-settings").hide();
        $("#line-"+ lineObj.LineNumber +"-btn-ShowCallStats").hide();
        $("#line-"+ lineObj.LineNumber +"-btn-HideCallStats").hide();
        $("#line-"+ lineObj.LineNumber +"-btn-ShowTimeline").hide();
...
function AddBuddyMessageStream(buddyObj) {
    ...
    profileRow += "<tr>"
    // Close|Return|Back Button
    //RRR profileRow += "<td style=\"width:38px; text-align: center;\">";
    //RRR profileRow += "<button id=\"contact-"+ buddyObj.identity +"-btn-back\" onclick=\"CloseBuddy('"+ buddyObj.identity +"')\" class=roundButtons style=\"margin-right:5px\" title=\""+ lang.back +"\"><i class=\"fa fa-chevron-left\"></i></button> ";
    //RRR profileRow += "</td>"
